...
let todayLabelColor = "black";

let lookByWeek = false;
const toggleButton = document.getElementById("toggle-button");
const btn = toggleButton.querySelector(".btn");
toggleButton.onclick = () => {
    lookByWeek = ! lookByWeek;
    if (toggleButton.title === "look by week") {
        toggleButton.title = "look by month";
        toggleButton.style.backgroundColor = todayLabelColor ? todayLabelColor : "black";
        btn.style.backgroundColor = "white";
        btn.style.left = "";
        btn.style.right = "0";
    } else {
        toggleButton.title = "look by week";
        toggleButton.style.backgroundColor = "white";
        btn.style.backgroundColor = todayLabelColor ? todayLabelColor : "white";
        btn.style.right = "";
        btn.style.left = "0";
    }
    createCalender();
        ...
        for (let d = 0; d < 7; d ++) {
            ...
            if (is_start) {
                ...
                if (isToday(year, month, date_count)) {
                    ...
                    toDayLabel.style.backgroundColor = todayLabelColor;
                    toDayLabel.style.borderColor = todayLabelColor;
                        ...
                        dateBox.onclick = () => {
                            ...
                            setTimeout(() => {
                                calenderSection.onclick = () => {
                                    listContainer.style.right = "-410px";
